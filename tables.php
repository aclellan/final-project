...
// Begin output
print '<article>';
print '<h2>Database: ' . ACLELLAN_FinalProject . '</h2>';
...
if (is_array($results)) {
    foreach ($results as $row) {
        ...
        print '<tr class="odd">';
        print '<th colspan="6">';
        print '<a href="?tblForwards=' . htmlentities($row[0], ENT_QUOTES) . "#" . htmlentities($row[0], ENT_QUOTES) . '">';
        ...
        print '<tr class="odd">';
        print '<th colspan="6">';
        print '<a href="?tblDefensemen=' . htmlentities($row[0], ENT_QUOTES) . "#" . htmlentities($row[0], ENT_QUOTES) . '">';
        print htmlentities($row[0], ENT_QUOTES) . '</a>';
        print '</th>';
        print '</tr>';
        ...
        print '<tr class="odd">';
        print '<th colspan="6">';
        print '<a href="?tblGoalies=' . htmlentities($row[0], ENT_QUOTES) . "#" . htmlentities($row[0], ENT_QUOTES) . '">';
        print htmlentities($row[0], ENT_QUOTES) . '</a>';
        print '</th>';
        print '</tr>';
